...
- A player can identify where to tap for primary gameplay actions while in map, battle, and victory scenes, including mobile-only zoom and replay actions when shown.
